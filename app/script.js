...
function answerYes() {
  if (document.body.classList.contains("answer_yes")) {
    document.body.classList.remove("answer_yes");
  } else {
    document.body.classList.add("answer_yes");
  }
  document.body.classList.remove("answer_no");
}

function answerNo() {
  // if answer no already exists
  if (document.body.classList.contains("answer_no")) {
    // remove it
    document.body.classList.remove("answer_no");
  } else {
    // otherwise, add it!
    document.body.classList.add("answer_no");
  }
  // remove answer yes
  document.body.classList.remove("answer_yes");
}
